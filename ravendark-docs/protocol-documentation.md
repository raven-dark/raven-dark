...
This document describes the protocol extensions for all additional functionality build into the RavenDark protocol. This doesn't include any of the RavenDark protocol, which has been left intact in the RavenDark project. For more information about the core protocol, please see https://en.ravendark.it/w/index.php?title#Protocol_documentation&action#edit
...
RavenDark Outpoint https://raven-dark.com/en/glossary/outpoint
...
RavenDark Input https://raven-dark.com/en/glossary/input
...
RavenDark Output https://raven-dark.com/en/glossary/output
...
RavenDark Public Key https://raven-dark.com/en/glossary/public-key
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | [CTxIn](#ctxin) | The unspent output which is holding 1000 RAVENDARK
| # | addr | [CService](#cservice) | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 1000 RAVENDARK unspent output
...
| 10004 | 5 | INSTANTSEND_MAX_VALUE | Controls the max value for an InstantSend transaction (currently 2000 ravendark)
| 10007 | 8 | MASTERNODE_PAYMENT_ENFORCEMENT | Requires masternodes to be paid by miners when blocks are processed
| 10008 | 9 | SUPERBLOCKS_ENABLED | Superblocks are enabled (the 10% comes to fund the ravendark treasury)
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin1 | [CTxIn](#ctxin) | The unspent output which is holding 1000 RAVENDARK for masternode 1
| 41 | vin2 | [CTxIn](#ctxin) | The unspent output which is holding 1000 RAVENDARK for masternode 2
