...
class RawTransactionsTest(RavenDarkTestFramework):
    ...
    def setup_network(self, split=False):
        ...
        #url = "http://ravendarkrpc:DP6DvqZtqXarpeNWyN3LZTFchCCyCUuHwNF7E8pX99x1@%s:%d" % ('127.0.0.1', 18332)
