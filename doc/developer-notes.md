...
RavenDark Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- RavenDarkMiner : Generates coins (if wallet is enabled).
...
However, in open source software such as RavenDark Core, where everyone uses
...
pay attention to for reviewers of RavenDark Core code.

General RavenDark Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: RavenDark Core uses tinyformat, which is type safe. Leave them out to avoid confusion
