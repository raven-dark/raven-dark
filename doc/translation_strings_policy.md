...
This document provides guidelines for internationalization of the RavenDark Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ravendark_en.ts` remains unchanged.
