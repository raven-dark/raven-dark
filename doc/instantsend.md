...
This mechanism has been integrated into Bitcore-Node-RavenDark which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/ravendark/insight-api-ravendark#web-socket-api](https://github.com/ravendark/insight-api-ravendark#web-socket-api)
* API: [https://github.com/ravendark/insight-api-ravendark#instantsend-transactions](https://github.com/ravendark/insight-api-ravendark#instantsend-transactions)
...
By default, the RavenDark Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the RavenDark Core daemon:
