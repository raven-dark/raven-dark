...
unlocked to sign the RavenDark-Qt.app bundle.
...
allowing somebody to distribute a RavenDark-Qt.app or ravendark-qt-setup.exe with a valid
...
that the ravendark-qt.exe file inside the installer had not been tampered with.
