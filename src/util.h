 ...
 */
#ifndef RAVENDARK_UTIL_H
#define RAVENDARK_UTIL_H
...
//#define ENABLE_RAVENDARK_DEBUG
#ifdef ENABLE_RAVENDARK_DEBUG
#define DBG( x ) x
#else
#define DBG( x ) 
#endif
...
extern const char * const RAVENDARK_CONF_FILENAME;
extern const char * const RAVENDARK_PID_FILENAME;
...
{
    std::string s = strprintf("ravendark-%s", name);
