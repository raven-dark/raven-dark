...
#ifndef RAVENDARK_CONSENSUS_PARAMS_H
#define RAVENDARK_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    uint32_t x21sForkTime;
    uint32_t getX21sForkTime() const {return x21sForkTime; };
};
} // namespace Consensus

#endif // RAVENDARK_CONSENSUS_PARAMS_H
