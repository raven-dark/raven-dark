...
#ifndef RAVENDARK_NET_H
#define RAVENDARK_NET_H
...
public:
    ...
    // Unfortunately, can't make this method private like in RavenDark,
    // because it's used in many RavenDark-specific places (masternode, privatesend).
