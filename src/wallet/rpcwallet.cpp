...
UniValue getnewaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "\nReturns a new RavenDark address for receiving payments.\n"
            "If 'account' is specified (DEPRECATED), it is added to the address book \n"
            "so payments received with the address will be credited to 'account'.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. The account name for the address to be linked to. If not provided, the default account \"\" is used. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created if there is no account by the given name.\n"
            "\nResult:\n"
            "\"ravendarkaddress\"    (string) The new ravendark address\n"
            "\nExamples:\n"
    ...
    return CRavenDarkAddress(keyID).ToString();
}


CRavenDarkAddress GetAccountAddress(string strAccount, bool bForceNew=false)
{
    ...
    return CRavenDarkAddress(account.vchPubKey.GetID());
}
...
UniValue getaccountaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current RavenDark address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"ravendarkaddress\"   (string) The account ravendark address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new RavenDark address, for receiving change.\n"
...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            "setaccount \"ravendarkaddress\" \"account\"\n"
            "\nDEPRECATED. Sets the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"ravendarkaddress\"  (string, required) The ravendark address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\", \"tabby\"")
        );

    LOCK2(cs_main, pwalletMain->cs_wallet);

    CRavenDarkAddress address(params[0].get_str());
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid RavenDark address");
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "getaccount \"ravendarkaddress\"\n"
            "\nDEPRECATED. Returns the account associated with the given address.\n"
            "\nArguments:\n"
            "1. \"ravendarkaddress\"  (string, required) The ravendark address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\"")
            + HelpExampleRpc("getaccount", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\"")
        );
...
UniValue getaddressesbyaccount(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "  \"ravendarkaddress\"  (string) a ravendark address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
    ...
    BOOST_FOREACH(const PAIRTYPE(CRavenDarkAddress, CAddressBookData)& item, pwalletMain->mapAddressBook)
    {
        const CRavenDarkAddress& address = item.first;
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 7)
        throw runtime_error(
            "sendtoaddress \"ravendarkaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount use_is use_ps )\n"
            "\nSend an amount to a given address.\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"ravendarkaddress\" (string, required) The ravendark address to send to.\n"
            ...
            "                             The recipient will receive less amount of RavenDark than you enter in the amount field.\n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 5)
        throw runtime_error(
            "instantsendtoaddress \"ravendarkaddress\" amount ( \"comment\" \"comment-to\" subtractfeefromamount )\n"
            "\nSend an amount to a given address. The amount is a real and is rounded to the nearest 0.00000001\n"
            + HelpRequiringPassphrase() +
            "\nArguments:\n"
            "1. \"ravendarkaddress\"  (string, required) The ravendark address to send to.\n"
            "2. \"amount\"      (numeric, required) The amount in XRD to send. eg 0.1\n"
            "3. \"comment\"     (string, optional) A comment used to store what the transaction is for. \n"
            "                             This is not part of the transaction, just kept in your wallet.\n"
            "4. \"comment-to\"  (string, optional) A comment to store the name of the person or organization \n"
            "                             to which you're sending the transaction. This is not part of the \n"
            ...
            "\"transactionid\"  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue listaddressgroupings(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"ravendarkaddress\",     (string) The ravendark address\n"
    ...
    BOOST_FOREACH(set<CTxDestination> grouping, pwalletMain->GetAddressGroupings())
    {
        ...
        BOOST_FOREACH(CTxDestination address, grouping)
        {
            ...
            addressInfo.push_back(CRavenDarkAddress(address).ToString());
            addressInfo.push_back(ValueFromAmount(balances[address]));
            {
                if (pwalletMain->mapAddressBook.find(CRavenDarkAddress(address).Get()) != pwalletMain->mapAddressBook.end())
                    addressInfo.push_back(pwalletMain->mapAddressBook.find(CRavenDarkAddress(address).Get())->second.name);
            }
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 2)
        throw runtime_error(
            "signmessage \"ravendarkaddress\" \"message\"\n"
            "\nSign a message with the private key of an address"
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"ravendarkaddress\"  (string, required) The ravendark address to use for the private key.\n"
            ...
            + HelpExampleCli("signmessage", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\", \"my message\"")
        );
    ...
    CRavenDarkAddress addr(strAddress);
    if (!addr.IsValid())
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 3)
        throw runtime_error(
            "getreceivedbyaddress \"ravendarkaddress\" ( minconf addlockconf )\n"
            "\nReturns the total amount received by the given ravendarkaddress in transactions with specified minimum number of confirmations.\n"
            "\nArguments:\n"
            "1. \"ravendarkaddress\"  (string, required) The ravendark address for transactions.\n"
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\", 6")
       );

    LOCK2(cs_main, pwalletMain->cs_wallet);

    // RavenDark address
    CRavenDarkAddress address = CRavenDarkAddress(params[0].get_str());
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid RavenDark address");
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 3 || params.size() > 7)
        throw runtime_error(
            "sendfrom \"fromaccount\" \"toravendarkaddress\" amount ( minconf addlockconf \"comment\" \"comment-to\" )\n"
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a ravendark address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"fromaccount\"    (string, required) The name of the account to send funds from. May be the default account using \"\".\n"
            "2. \"toravendarkaddress\"  (string, required) The ravendark address to send funds to.\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );

    LOCK2(cs_main, pwalletMain->cs_wallet);

    string strAccount = AccountFromValue(params[0]);
    CRavenDarkAddress address(params[1].get_str());
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid RavenDark address");
    CAmount nAmount = AmountFromValue(params[2]);
    if (nAmount <= 0)
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 8)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount     (numeric or string) The ravendark address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less ravendarks than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\\\":0.01,\\\"MuQQkwA4FYkq2XERzMY2CiAZhJTEDAMTNg\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\\\":0.01,\\\"MuQQkwA4FYkq2XERzMY2CiAZhJTEDAMTNg\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\\\":0.01,\\\"MuQQkwA4FYkq2XERzMY2CiAZhJTEDAMTNg\\\":0.02}\", 6, false, \"testing\"")
        );
    ...
    set<CRavenDarkAddress> setAddress;
    vector<CRecipient> vecSend;
    ...
    {
        CRavenDarkAddress address(name_);
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid RavenDark address: ")+name_);
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 2 || params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a RavenDark address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keysobject\"   (string, required) A json array of ravendark addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) ravendark address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. An account to assign the addresses to.\n"

            "\nResult:\n"
            "\"ravendarkaddress\"  (string) A ravendark address associated with the keys.\n"
    ...
    return CRavenDarkAddress(innerID).ToString();
}
...
UniValue ListReceived(const UniValue& params, bool fByAccounts)
{
    ...
    // Tally
    map<CRavenDarkAddress, tallyitem> mapTally;
    for (map<uint256, CWalletTx>::iterator it = pwalletMain->mapWallet.begin(); it != pwalletMain->mapWallet.end(); ++it)
    {
        const CWalletTx& wtx = (*it).second;
    ...
    BOOST_FOREACH(const PAIRTYPE(CRavenDarkAddress, CAddressBookData)& item, pwalletMain->mapAddressBook)
    {
        ...
        map<CRavenDarkAddress, tallyitem>::iterator it = mapTally.find(address);
...
UniValue listtransactions(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"ravendarkaddress\",  (string) The ravendark address of the transaction. Not present for \n"
...
UniValue listsinceblock(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"ravendarkaddress\",  (string) The ravendark address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "      \"address\" : \"ravendarkaddress\",      (string) The ravendark address involved in the transaction\n"
...
UniValue walletpassphrase(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() < 2 || params.size() > 3))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending ravendarks\n"
            "\nArguments:\n"
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    ...
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\" 1.0") +
...
UniValue encryptwallet(const UniValue& params, bool fHelp)
{
    ...
    if (!pwalletMain->IsCrypted() && (fHelp || params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending ravendark\n"
            + HelpExampleCli("walletpassphrase", "\"my pass phrase\"") +
            "\nNow we can so something like sign\n"
            + HelpExampleCli("signmessage", "\"ravendarkaddress\" \"test message\"") +
    ...
    StartShutdown();
    return "Wallet encrypted; RavenDark Core server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending ravendarks.\n"
...
UniValue listunspent(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 3)
        throw runtime_error(
            ...
            "3. \"addresses\"      (string) A json array of ravendark addresses to filter\n"
            "    [\n"
            "      \"address\"     (string) ravendark address\n"
            "      ,...\n"
            "    ]\n"
            "\nResult\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the ravendark address\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\\\",\\\"MuQQkwA4FYkq2XERzMY2CiAZhJTEDAMTNg\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"AbWMQqUNEosjjEb9WAGuJ5KGN9h4WL5bqf\\\",\\\"MuQQkwA4FYkq2XERzMY2CiAZhJTEDAMTNg\\\"]\"")
        );
    ...
    if (params.size() > 2) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            CRavenDarkAddress address(input.get_str());
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid RavenDark address: ")+input.get_str());
            if (setAddress.count(address))
    ...
    BOOST_FOREACH(const COutput& out, vecOutputs) {
        ...
        CTxDestination address;
        if (ExtractDestination(out.tx->vout[out.i].scriptPubKey, address)) {
            entry.push_back(Pair("address", CRavenDarkAddress(address).ToString()));
