...
#ifndef RAVENDARK_WALLET_WALLET_H
#define RAVENDARK_WALLET_WALLET_H
...
public:
    ...
    /// Get 1000RAVENDARK output and keys which can be used for the Masternode
...
#endif // RAVENDARK_WALLET_WALLET_H
