 ...
 *
 *   // network
 *   CRavenDarkNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.raven-dark.com/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CRavenDarkNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CRavenDarkNetwork(UniValue objIn)
    {
...
// // can be under: RavenDarkNetwork
// //   -- signature requirements : Key1(User)
// class CRavenDarkNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == RavenDarkNetwork);
//     // }
