...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RavenDarkNetwork") type = RavenDarkNetwork;
    if(strType == "RavenDarkNetworkVariable") type = RavenDarkNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RavenDarkNetwork) s = "RavenDarkNetwork";
    if(type == RavenDarkNetworkVariable) s = "RavenDarkNetworkVariable";
