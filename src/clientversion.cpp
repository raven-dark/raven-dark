 ...
 * for both ravendarkd and ravendark-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("RavenDark Core");
...
/** 
 * Format the subversion field according to BIP 14 spec (https://github.com/ravendark/bips/blob/master/bip-0014.mediawiki) 
 */
