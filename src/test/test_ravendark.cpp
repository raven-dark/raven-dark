...
#define BOOST_TEST_MODULE RavenDark Test Suite

#include "test_ravendark.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_ravendark_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
