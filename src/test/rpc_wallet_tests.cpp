...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CRavenDarkAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CRavenDarkAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CRavenDarkAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CRavenDarkAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CRavenDarkAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CRavenDarkAddress(arr[0].get_str()).Get() == demoAddress.Get());
