...
#ifndef RAVENDARK_TEST_SCRIPTNUM10_H
#define RAVENDARK_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from RavenDark Core 0.10.0, for cross-comparison.
 */
public:
