    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("RAVENDARK-light"), QVariant("light"));
    ui->theme->addItem(QString("RAVENDARK-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("RAVENDARK-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("RAVENDARK-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("RAVENDARK-traditional"), QVariant("trad"));
    ...
    ui->unit->setModel(new RavenDarkUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->ravendarkAtStartup, OptionsModel::StartAtStartup);
