...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR) || dataDirDefaultCurrent != dataDirDefaultSettings)
    {
        ...
        intro.setWindowIcon(QIcon(":icons/ravendark"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("RavenDark Core"),
     ...
     * override -datadir in the ravendark.conf file in the default data directory
     * (to be consistent with ravendarkd behavior)
     */
