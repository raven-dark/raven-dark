...
#include "config/ravendark-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatRavenDarkURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + RavenDarkUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatRavenDarkURI(info));
}
