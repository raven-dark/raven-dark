...
#ifndef RAVENDARK_QT_OPTIONSMODEL_H
#define RAVENDARK_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for RavenDark client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // RavenDarkUnits::Unit
...
#endif // RAVENDARK_QT_OPTIONSMODEL_H
