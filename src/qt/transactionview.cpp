...
void TransactionView::changedAmount(const QString &amount)
{
    ...
    // Replace "," by "." so RavenDarkUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if(RavenDarkUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed))
    {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(RavenDarkUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(RavenDarkUnits::formatWithUnit(nDisplayUnit, amount, true, RavenDarkUnits::separatorAlways));
