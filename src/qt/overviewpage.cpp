...
public:
    TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(RavenDarkUnits::XRD),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        painter->setPen(foreground);
        QString amountText = RavenDarkUnits::floorWithUnit(unit, amount, true, RavenDarkUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(RavenDarkUnits::floorHtmlWithUnit(nDisplayUnit, balance, false, RavenDarkUnits::separatorAlways));
    ui->labelUnconfirmed->setText(RavenDarkUnits::floorHtmlWithUnit(nDisplayUnit, unconfirmedBalance, false, RavenDarkUnits::separatorAlways));
    ui->labelImmature->setText(RavenDarkUnits::floorHtmlWithUnit(nDisplayUnit, immatureBalance, false, RavenDarkUnits::separatorAlways));
    ui->labelAnonymized->setText(RavenDarkUnits::floorHtmlWithUnit(nDisplayUnit, anonymizedBalance, false, RavenDarkUnits::separatorAlways));
    ui->labelTotal->setText(RavenDarkUnits::floorHtmlWithUnit(nDisplayUnit, balance + unconfirmedBalance + immatureBalance, false, RavenDarkUnits::separatorAlways));
    ui->labelWatchAvailable->setText(RavenDarkUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance, false, RavenDarkUnits::separatorAlways));
    ui->labelWatchPending->setText(RavenDarkUnits::floorHtmlWithUnit(nDisplayUnit, watchUnconfBalance, false, RavenDarkUnits::separatorAlways));
    ui->labelWatchImmature->setText(RavenDarkUnits::floorHtmlWithUnit(nDisplayUnit, watchImmatureBalance, false, RavenDarkUnits::separatorAlways));
    ui->labelWatchTotal->setText(RavenDarkUnits::floorHtmlWithUnit(nDisplayUnit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, RavenDarkUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    {
        // update the display unit, to not use the default ("XRD")
        updateDisplayUnit();
...
void OverviewPage::updatePrivateSendProgress()
{
    ...
    QString strPrivateSendAmount = RavenDarkUnits::formatHtmlWithUnit(nDisplayUnit, privateSendClient.nPrivateSendAmount * COIN, false, RavenDarkUnits::separatorAlways);
    ...
    if(currentBalance == 0)
    {
        ...
        strPrivateSendAmount = strPrivateSendAmount.remove(strPrivateSendAmount.indexOf("."), RavenDarkUnits::decimals(nDisplayUnit) + 1);
    ...
    if(nMaxToAnonymize >= privateSendClient.nPrivateSendAmount * COIN) {
        ...
        QString strMaxToAnonymize = RavenDarkUnits::formatHtmlWithUnit(nDisplayUnit, nMaxToAnonymize, false, RavenDarkUnits::separatorAlways);
        ui->labelAmountRounds->setToolTip(tr("Not enough compatible inputs to anonymize <span style='color:red;'>%1</span>,<br>"
                                             "will anonymize <span style='color:red;'>%2</span> instead")
                                          .arg(strPrivateSendAmount)
                                          .arg(strMaxToAnonymize));
        strMaxToAnonymize = strMaxToAnonymize.remove(strMaxToAnonymize.indexOf("."), RavenDarkUnits::decimals(nDisplayUnit) + 1);
        strAmountAndRounds = "<span style='color:red;'>" +
                QString(RavenDarkUnits::factor(nDisplayUnit) == 1 ? "" : "~") + strMaxToAnonymize +
...
void OverviewPage::togglePrivateSend(){
    ...
    if(!privateSendClient.fEnablePrivateSend){
        ...
        if(currentBalance < nMinAmount){
            QString strMinAmount(RavenDarkUnits::formatWithUnit(nDisplayUnit, nMinAmount));
            QMessageBox::warning(this, tr("PrivateSend"),
