...
#ifndef RAVENDARK_QT_RAVENDARKUNITS_H
#define RAVENDARK_QT_RAVENDARKUNITS_H
...
/** RavenDark unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class RavenDarkUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RavenDarkUnits(QObject *parent);

    /** RavenDark units.
      @note Source: https://en.ravendark.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        XRD,
...
typedef RavenDarkUnits::Unit RavenDarkUnit;

#endif // RAVENDARK_QT_RAVENDARKUNITS_H
